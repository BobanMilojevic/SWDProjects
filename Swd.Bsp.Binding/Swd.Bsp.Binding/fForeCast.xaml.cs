...
public partial class fForeCast : Window
{
    ...
    private void BtnLoadRealtimeData_OnClick(object sender, RoutedEventArgs e)
    {
    ...
    {
        string apiCall =
        "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/Feldkirch?unitGroup=metric&key=PDUA3AMU3W845XYNADGEFY9Y5&contentType=json";
